...
class Document(Base):
    ...
    receipt_header: Mapped[dict[str, Any] | None] = mapped_column(JSON)
    application_timestamp: Mapped[Any | None] = mapped_column(UTCDateTime())
    rch_footer_timestamp: Mapped[Any | None] = mapped_column(UTCDateTime())
    rch_serial_number: Mapped[str | None] = mapped_column(String(64))
