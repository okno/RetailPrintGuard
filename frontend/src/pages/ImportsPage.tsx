...
export function ImportsPage() {
  ...
  const query = useQuery({
    queryKey: scopedQueryKey('imports', limit, offset),
    queryFn: () => api<Page<ImportBatch>>(`/imports?limit=${limit}&offset=${offset}`),
