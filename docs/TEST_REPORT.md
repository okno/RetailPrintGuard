...
| `.venv\\Scripts\\python -m pytest -q -p no:cacheprovider` sul monorepo `0.1.2` prima della pubblicazione | Windows, CPython 3.12.13 | `92 passed, 14 skipped`, 1 warning Starlette/httpx; gate rieseguito dopo l'hardening dell'handover di rete |
